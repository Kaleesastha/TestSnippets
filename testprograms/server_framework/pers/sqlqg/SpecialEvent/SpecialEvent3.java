 ...
 */ 
public class SpecialEvent3 extends Event
{

	private String specialEventName="defaultName";
    private int specialEventValue =2;
    ...
    public void setSpecialEventValue(int sev)
    {
        this.specialEventValue = sev;
    }
    ...
    public int getSpecialEventValue()
    {
        return specialEventValue;
    }
    ...
    public void setProperties(Properties p)
    {
        ...
        if((val = (String)p.remove("specialEventValue"))!= null)
        {
            this.specialEventValue = Integer.parseInt(val);
        }
    ...
    public Properties getProperties()
    {
        ...
        p.put("specialEventValue",String.valueOf(specialEventValue));
        return p;
    }
