	...
	public Object applyTrapFilter(SnmpPDU pdu)
	{
		...
		{   
			...
			for (Enumeration e = pdu.getVariableBindings().elements();e.hasMoreElements();)
				...
				System.err.println("=="+pdu.getSecurityModel());
				String str1 = new String(pdu.getUserName());
				System.err.println("Username : ********"+str1);
				if(pdu.getEngineID()!=null){
					String str2 = new String(pdu.getEngineID());
					System.err.println("Engine ID: ********"+str2);
				}else { 
					System.err.println("Engine ID is NULL");
				}
				if(pdu.getContextID()!= null){
					String str3 = new String(pdu.getContextID());
					System.err.println("Context ID :********"+str3);
				} else { 
					System.err.println("Context ID is NULL");
				}
				if(pdu.getContextName()!= null){
					String str4 = new String(pdu.getContextName());
					System.err.println("Context Name :********"+str4);	
				}else { 
					System.err.println("Context Name is NULL");
				}
				if(pdu.getData()!= null){
					String str = new String(pdu.getData());
