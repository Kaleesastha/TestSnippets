//$Id: NmsInSSL.java,v 1.1.4.1 2014/03/06 10:34:00 venkatramanan Exp $
...
public class NmsInSSL
{
    ...
    private static boolean isEverythingOK(String arg[])
    {
	    ...
	    try
	    {
		    ...
		    fis = CommonUtil.openFile(new File(transport_file));
		    if(sslOverRMI)
		    {
	    ...
	    catch(Exception e)
	    {
		    ...
		    try{fis.close(); fis = null;} catch(Exception exp){}
		    return OK;
	    }
    }
}
