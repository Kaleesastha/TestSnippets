...
public class CommonDBStoreExtn extends CommonDBStore
{
	boolean isDB = true;
    public com.adventnet.nms.store.relational.CommonTopoToRelational comtorel;  
    //public com.adventnet.nms.store.relational.CommonAlertToRelational comtorel;  

	public CommonDBStoreExtn () throws NmsStorageException {
		super();
		isDB = PureServerUtils.useJDBC;
		setPersistenceAPI();
	}
	public CommonDBStoreExtn (boolean isDatabase) throws NmsStorageException {
		super();
		isDB = isDatabase;
		setPersistenceAPI();
	}
	public CommonDBStoreExtn (int numberInMemory) throws NmsStorageException {
		super(numberInMemory);
		isDB = PureServerUtils.useJDBC;
		setPersistenceAPI();
	}
	public CommonDBStoreExtn (int numberInMemory,boolean isDatabase) throws NmsStorageException {
		super(numberInMemory);
		isDB = isDatabase;
		setPersistenceAPI();
	}
	...
	protected void setPersistenceAPI() throws NmsStorageException {
		if(isDB) {
            ...
            //comtorel = new com.adventnet.nms.store.relational.CommonAlertToRelational();
