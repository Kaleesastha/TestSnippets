...
//$Id: MapFilterUI.java,v 1.1 2006/08/29 13:57:02 build Exp $
...
public class MapFilterUI extends JPanel implements ActionListener,ApplyToServerInterface
{
	...
	MapFilterModel mapFilterModel = null;
...
//<UserCode_End_Bean_JPanel9>
          ...
          try
          {
            JLabel1.setText(resourceBundle.getString("Map Filter Configuration"));
...
//<UserCode_End_Bean_JLabel1>
          ...
          try
          {
            ...
            JLabel6.setText(resourceBundle.getString("( map.filters )"));
          }
          catch(Exception ex)
          {
...
//<UserCode_End_Bean_tableModel>
		...
		JPanel6.setPreferredSize(new Dimension(JPanel6.getPreferredSize().width+242,JPanel6.getPreferredSize().height+0));
		JLabel4.setPreferredSize(new Dimension(JLabel4.getPreferredSize().width+146,JLabel4.getPreferredSize().height+232));
...
tableModel.setDataVector(
  ...
  //<Begin_init> 
	...
	resourceBundle = com.adventnet.apiutils.Utility.getBundle(localePropertiesFileName,getParameter("RESOURCE_LOCALE"),applet);
        ...
        setPreferredSize(new Dimension(getPreferredSize().width+715,getPreferredSize().height+527)); 
	...
	JTextArea2.setText(resourceBundle.getString("Use reload option to load MapFilter classes again in the WebNMS server at runtime."));
	JTextArea1.setEditable(false);
	JTextArea2.setEditable(false);
	table.getTableHeader().setReorderingAllowed(false);
	reloadButton.setEnabled(false);
	JLabel5.setIcon(RuntimeConfigFrame.getCommonBuilderUIImpl().getImage("mapfilter.png", "images/runtimeadmin"));
...
//<UserCode_End_Connection_deleteButton_deleteButton_conn1>
  ...
  public MapFilterUI(java.applet.Applet applet)
  {
    //<Begin_MapFilterUI_java.applet.Applet>
    this.applet = applet;
    this.init();
  
    //<End_MapFilterUI_java.applet.Applet>
  ...
  {
	mapFilterModel = new MapFilterModel(this);
	RuntimeConfigFrame.setStatusText(resourceBundle.getString("Loading Map Filter data....."));
	mapFilterModel.getFilterNodes();
	...
	//removed by rameshp - this method is never called
	/*  
	public void classpathButtonActionPerformed()
	{
		ClassPathDialog classPathDialog = new ClassPathDialog();
	...
	public boolean  applyToServer()
	{
      try
      {
		if(isModified())
		{
			...
			mapFilterModel.setFilterNodes(setVector,reOrder);
			reOrder = false;
			isModified = false;
			applyButton.setEnabled(false);
...
//<UserCode_End_Connection_reloadButton_reloadButton_conn1>
	...
	public void reloadButtonActionPerformed()
	{
		...
		mapFilterModel.reloadFilterNode(reloadArray); 
	}
...
//End of MapFilterUI
  ...
  //added for RTA fix to SPP team
  public void dispose()
  {
      
      mapFilterModel.mapConfiguartionSession.dispose();      
