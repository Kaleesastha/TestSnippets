/*$Id: AssignOperationToView.java,v 1.1.1.1 2006/11/16 15:39:58 gramkumar Exp $*/
/*
 * @(#)AssignOperationToView.java
 ...
 * "assignOperationToView(String operationName,String authorizedViewName)".
 */
public class AssignOperationToView 
{
	...
	public static void main(String args[]) 
	{
		...
		if( args.length < 2 ) 
		{
			System.out.println("Usage: java com.adventnet.nms.example.security.authorization.AssignOperationToView <operationName> <viewName> ");
			System.exit(1);
		}
		...
		try 
		{
			...
			authAdmin.assignOperationToView(operationName,viewName); // API Call.
			System.out.println("Assigned " + operationName + " to " + viewName);
