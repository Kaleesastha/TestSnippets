...
public class AuthenticationServlet extends HttpServlet{
	...
	public void  service(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out = null;
			...
			System.err.println("password in session.getAttribute is : "+password);
				...
				System.err.println("password in request.getParameter is : "+password);
			    } else {
				    System.err.println("password in request.getHeader is : "+password);
			    }
                        }
                        forCheck = password;
                    }
