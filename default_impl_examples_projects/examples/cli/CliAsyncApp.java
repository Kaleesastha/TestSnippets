/* $Id: CliAsyncApp.java,v 1.1.1.1 2006/11/16 15:39:58 gramkumar Exp $ */
/*
 * @(#)CliAsyncApp.java
 ...
 *
 * Example Usage: java CliAsyncApp localhost -l guest -p guest "ls -l" 
 */  
 

public class CliAsyncApp implements CLIClient{
    
    public static void main(String args[]){
			
	// Take care of getting options
        
	String usage = "java CliAsyncApp [-s session(d/nd)] [-n RemotePort] [-cp CmdPrompt]  [-lp LoginPrompt ] [-pp PasswordPrompt ] [-l LoginName ] [-p Password ] [-d Debug ] RemoteHost Command";
