...
cd ..
. ./setEnv.sh
echo ============================$NMS_HOME/classes/NmsClientClasses.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/classes/NmsClientClasses.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/classes/NmsClientClasses.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/AdventNetSnmp.jar====================
cd $NMS_HOME/temp/
...
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/AdventNetUtils.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/classes/AdventNetUtils.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/classes/AdventNetUtils.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/ApiUtils.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/classes/ApiUtils.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/classes/ApiUtils.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/AdventNetTL1.jar====================
cd $NMS_HOME/temp/
...
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/ManagementClient.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/classes/ManagementClient.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/classes/ManagementClient.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/AdventNetCLIClient.jar====================
cd $NMS_HOME/temp/
...
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/NetMonitor/build/PerformanceGraphs.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/NetMonitor/build/PerformanceGraphs.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/NetMonitor/build/PerformanceGraphs.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/NetMonitor/build/RuntimeConfigFrame.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/NetMonitor/build/RuntimeConfigFrame.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/NetMonitor/build/RuntimeConfigFrame.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/NetMonitor/build/AuthMain.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/NetMonitor/build/AuthMain.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/NetMonitor/build/AuthMain.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/NetMonitor/build/ConfigPanel.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/NetMonitor/build/ConfigPanel.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/NetMonitor/build/ConfigPanel.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/AdventNetSnmpV3USM.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/classes/AdventNetSnmpV3USM.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/classes/AdventNetSnmpV3USM.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/ClientExamples.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/classes/ClientExamples.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/classes/ClientExamples.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/AdventNetAboutDialog.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/classes/AdventNetAboutDialog.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/classes/AdventNetAboutDialog.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/jnlp.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/classes/jnlp.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/classes/jnlp.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/AdventNetCCLLibrary.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/classes/AdventNetCCLLibrary.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/classes/AdventNetCCLLibrary.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/AdventNetProBeans.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/classes/AdventNetProBeans.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/classes/AdventNetProBeans.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/Mail.jar====================
cd $NMS_HOME/temp/
...
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/AdventNetDMPModels.jar====================
cd $NMS_HOME/temp/
jar -xf $NMS_HOME/classes/AdventNetDMPModels.jar
rm -rf META-INF
jar -cf test.jar *
mv test.jar $NMS_HOME/classes/AdventNetDMPModels.jar
rm -rf $NMS_HOME/temp/*
cd ..
echo ============================$NMS_HOME/classes/AdventNetNPrevalent.jar====================
cd $NMS_HOME/temp/
