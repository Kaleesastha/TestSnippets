...
public class ParentCorrelator implements EventToAlertCorrelator
{
    public void init()
    {
    ...
    private int parentAlertCount=1;
    ...
    public Hashtable getNeededAlertProps()
    {
        ...
        Vector parentAlert = new Vector();
        parentAlert.add("parentAlertEntity");
        parentAlert.add("parentAlertSource");
        table.put("ParentAlert",parentAlert);
        return table;
    }
    ...
    private Alert createAlert(Event fail)
    {
        ...
        else if(fail.getSeverity()==3)
        {
            ...
            a.setSource(fail.getEntity()+"ParentAlert"+parentAlertCount);
            
            ((ParentAlert)a).setParentAlertEntity(a.getSource());
            ((ParentAlert)a).setParentAlertSource(a.getSource());
            ((ParentAlert)a).setParentAlertSeverity(parentAlertCount);
            parentAlertCount++;
        }
