...
public class TestBEParameters extends HttpServlet
{
    ...
    public synchronized void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	{
		...
		System.out.println("NATIVE_PING" + NmsUtil.nativePing);
		...
		System.out.println("PureUtils.rootDir"+PureUtils.rootDir);
