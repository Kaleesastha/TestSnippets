...
(2) In the classname tag include classname=com.adventnet.nms.tools.confchanges.Emptyimplexception
Note:This Class throws an Exception
...
public class Emptyimplexception  extends AbstractConfChanges
{
    ...
    */
    ...
    public boolean updateChanges(ConfNode node,File productConfHome,File productHome,File backupDir ) throws ConfUpgradeException
    {
		...
		//Checking Exception;
		System.out.println("into new exception");
		int ii=1;
		ConfUpgradeException exobj1 = new ConfUpgradeException();
		if (ii==1)
		throw exobj1;
    ...
    private void copyTheFile(File source, File destination)
    {
     ...
     public void revertChanges(File productConfHome,File productHome,File backupDir) throws ConfUpgradeException
	    {
	        System.out.println(" *******************************************");
