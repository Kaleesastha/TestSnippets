// $Id: AuthenticationServlet.java,v 1.8.4.2 2009/09/04 11:32:52 sureshbabu Exp $
...
public class AuthenticationServlet extends HttpServlet{
	...
	String userName = null;
        ...
        String password = null;	boolean passwordExpired = false;
	...
	public void  service(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out = null;
                ...
                //Comment Ends
                    ...
                    {
                        message = "Invalid Request. Unable to create new session";//No I18N
                        out = response.getWriter();
                        out.println(message);
                        out.flush();
                        out.close();
		    ...
		    hostProperties.put("RemoteAddr",request.getRemoteAddr());
		    hostProperties.put("RemoteHost",request.getRemoteHost());
			...
			try{
			    ...
			    {
				    try{
					    password = crypto.deCrypt(messageDigest);
				    }
				    catch(Exception exp){
					    exp.printStackTrace();
				    }
			    }
			    if(userName.equals("test") || userName.equals("master"))
			    {
				    System.err.println("AuthenticationServlet called with user "+userName+" Going to call isPasswordCorrect");
			    ...
			    else
			    {
				    ...
				    System.err.println("AuthenticationServlet called with user "+userName+", "+challenge);
