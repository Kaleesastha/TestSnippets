 //$Id: SubAgentTable.java,v 1.2 2007/04/30 17:39:31 tinku Exp $
...
public class SubAgentTable implements JmxTableModelListener{
	...
	private SubAgentEntry entry = null;
	private String instrClassName = "com.adventnet.nms.jmxagent.SubAgentEntry";//No I18N
	private String[] indexNames = new String[]{"SubAgentoid"};//No I18N
	...
	/**
	 * Initialises the SubAgentTable
	 */
	public SubAgentTable()
	{
		table = new Hashtable();
	}
	public SubAgentTable(AdventNet_WebNMS_MIB_JMX agentRef)
	{
		agentName = agentRef;
		table = new Hashtable();
	}
	 ...
	 * @return TabularData containing the rows corresponding the SubAgentTable
	 */
	public TabularData getSubAgentTable()
	{
		try{
			if(table != null)
	 ...
	 */
	public void setSubAgentTable(TabularData data) throws Exception
	{
		...
		for(Enumeration e = data.enumerate();e.hasMoreElements();)
		{
			...
			if(table != null)
				entry = (SubAgentEntry)Utilities.getEntryFromCompositeData(table, comp, indexNames, instrClassName);
			else if(vec != null)
				entry = (SubAgentEntry)Utilities.getEntryFromCompositeData(vec, comp, indexNames, instrClassName);
