/*$Id: TidPropertiesDialog.java,v 1.1 2006/08/29 13:57:02 build Exp $ */
...
public class TidPropertiesDialog extends JDialog 
{
  ...
  public TidPropertiesDialog()
  {
      //<Begin_TidPropertiesDialog>
    pack();
    
    //<End_TidPropertiesDialog>
    setModal(true);
  }

  public TidPropertiesDialog(java.applet.Applet applet)
  {
    //<Begin_TidPropertiesDialog_java.applet.Applet>
    this.applet = applet;
    pack();
    this.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
  
    //<End_TidPropertiesDialog_java.applet.Applet>
  }
    ...
    public void init()
  {
	...
	resourceBundle = com.adventnet.apiutils.Utility.getBundle(localePropertiesFileName,getParameter("RESOURCE_LOCALE"),applet);
        ...
        this.setSize(getPreferredSize().width+508,getPreferredSize().height+470); 
          setTitle(resourceBundle.getString("TidPropertiesDialog"));
...
//<UserCode_End_Bean_JTextField1>
          ...
          try
          {
            ...
            JLabel1.setText(resourceBundle.getString("TID Name"));
          }
          catch(Exception ex)
          {
...
//<UserCode_End_Bean_JLabel1>
          ...
          try
          {
            ...
            JLabel3.setText(resourceBundle.getString("TID Properties"));
          }
          catch(Exception ex)
          {
...
//<UserCode_End_Bean_JButton2>
		...
		JLabel3.setPreferredSize(new Dimension(JLabel3.getPreferredSize().width+55,JLabel3.getPreferredSize().height+1));
  ...
  public void setConstraints(int x,int y,int width,int height,double wtX,double wtY,int anchor,int fill,Insets inset,int padX,int padY )
  {
    ...
    public void showTIDDlg(Hashtable props)
    {
        clear();
        currProps = props;
        if(props.get("tid") != null)
        {
            JTextField1.setText(props.get("tid").toString());
        }
        if(TypePropertiesPanel1.JTextField2.isVisible())
	    {
            TypePropertiesPanel1.JTextField2.setVisible(false);
            TypePropertiesPanel1.JLabel2.setVisible(false);
	    }
    ...
    {
        currProps.put("tid",JTextField1.getText());
