...
//import com.adventnet.nms.mapui.MapSymbol;
    ...
    void invokeMethod() {
        ...
        if (((returnType.getName()).indexOf("java.util.Vector")) != -1) {
            ...
            for ( Enumeration en = v.elements(); en.hasMoreElements(); ) {
                ...
                if ( obj instanceof MapSymbol )
                    strBuf.append( ((MapSymbol)obj).getProperties() + " \n"); //getObjects()
                else
                    strBuf.append( obj + " \n");
            }
            ...
            try {
                ...
                if (obj == null) {
                    ...
                    if ( obj instanceof ManagedMapObject )
                        ...
                        System.out.println("--- mapdb :: " + obj);
                        strBuf.append("MapDB :: props = " + ((MapDB)obj).getProperties() + " \n");
                        strBuf.append("         criteria props = " + ((MapDB)obj).getCriteriaProperties() + " \n");
                        System.out.println("MapDB :: props = " + ((MapDB)obj).getProperties() + " \n");
                        System.out.println("criteria props = " + ((MapDB)obj).getCriteriaProperties() + " \n");
        ...
        }else if (((returnType.getName()).indexOf("[java.lang.String")) != -1) {
            try {
        ...
        try {
            try {
                if ( args.length > 0 )
                {
                    ...
                    System.out.println(" MapApi:------>"+topoDefa);
                }
                else
                    topoDefa = (MapAPI)Naming.lookup("//kosim/MapAPI");
            }catch(Exception e) {
