/*$Id: AssignUserToGroup.java,v 1.1.1.1 2006/11/16 15:39:58 gramkumar Exp $*/
/*
 * @(#)AssignUserToGroup.java
...
public class AssignUserToGroup 
{
	...
	public static void main(String args[]) 
	{
		...
		if(args.length < 2) 
		{
			System.out.println("Usage: java com.adventnet.nms.example.security.authorization.AssignUserToGroup <userName> <groupName> ");
			System.exit(1);
		}
