...

{
    ...
    public void actionPerformed(ActionEvent aevent)
    {
        ...
        if(cfwapi != null)
        {
            ...
            //** Comment the following line for test case :CATS-JCF-API-CFW-003 
            cfwapi.registerParentComponent(this);
            //** Comment the following line for test case :CATS-JCF-API-CFW-007/008
        ...
        if(masocketclnt != null )
        {
           ...
           masocketclnt. showCustomizedServerClosedDialog( new JOptionPane("Connection Lost",
                                                                           JOptionPane.ERROR_MESSAGE,
                                                                           JOptionPane.YES_NO_OPTION,
                                                                           null),"ServerClosed"); //** For the test cases 12 to 15 change this line
        }
    ...
    {
        //*** Uncomment the following print statement for the test case : CATS-JCF-API-CFW-006
        //    System.out.println("Server Shutdown Called....");

        //*** Uncomment the following statement for the test case : CATS-JCF-API-CFW-009
        //    System.exit(0);
    }
