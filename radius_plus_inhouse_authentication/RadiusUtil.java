...
public class RadiusUtil 
{
	...
	public int authenticateUser(String userName,String userPass) throws  AuthenticationException 
	{
			try
			{
...
//	radiusClient.authenticate("public");
			...
			System.err.println("RADIUS result : "+result);//No Internationalisation 
			if (  result == 2 ) 
			{
			...
			{
				System.err.println("RADIUS: ACCESS_REJECT");//No Internationalisation 
				return 3;
			}
			else
			{
