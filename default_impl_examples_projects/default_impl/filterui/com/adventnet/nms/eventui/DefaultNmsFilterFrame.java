//$Id: DefaultNmsFilterFrame.java,v 1.2.4.1 2012/01/25 05:09:27 karen.r Exp $
...
int YES   = 2;
	...
	setESCFunction();
        ...
        actionTable.setDefaultRenderer(new Object().getClass(),new MyRenderer1());
	initIcons();      
   ...
   public void addTreeNode(String treename)
	...
	String filterName = prop.getProperty("name");
        if(filterName==null || filterName.trim().equals(""))
	{
		JOptionPane.showMessageDialog(this, NmsClientUtil.GetString("javaui.filter.addName"), NmsClientUtil.GetString("javaui.filter.errormessage")
, JOptionPane.ERROR_MESSAGE);//No i18n
                return false;
	}
    ...
    private void initComponents() {
        ...
        jScrollPane2.setPreferredSize(new java.awt.Dimension(150, 110));
	...
	jScrollPane1 = new JScrollPane(actionTable);	
	jScrollPane1.setBackground(new java.awt.Color(255, 255, 255));
        jScrollPane1.setHorizontalScrollBarPolicy(javax.swing.JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        jScrollPane1.setPreferredSize(new java.awt.Dimension(25, 5));
            ...
            item.addActionListener(new ActionListener()
               {
                  public void actionPerformed(ActionEvent e)  
                    {
			String selectedSeverity = e.getActionCommand();
			Vector severityVec = new Vector();
			StringTokenizer strToken = new StringTokenizer(severity.getText()," ");
			while(strToken.hasMoreElements())
		        {
				String addSev = (String)strToken.nextElement();
				severityVec.add(addSev);
                        }
	    		if(!severityVec.contains(selectedSeverity))
		    	{
                        	String a = severity.getText() + " " + selectedSeverity;
                        	severity.setText(a);
			}
                    }
                }
	...
	if(filterCount <= 0)
        ...
        AddFilterAction action = new AddFilterAction(this, true);
    ...
    public class MyRenderer extends DefaultTreeCellRenderer 
    {
     ...
     public class MyRenderer1 extends DefaultTableCellRenderer
    {
	public MyRenderer1()
        {
