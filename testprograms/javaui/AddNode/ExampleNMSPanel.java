...
public class ExampleNMSPanel extends AbstractBaseNmsPanel implements InternalFrameListener
{
    ...
    {
        System.out.println("examplenmspanel initlayout invoked ") ;
    ...
    {
        System.out.println("examplenmspanel init invoked ") ;
    ...
    {
        System.err.println("ExampleNMSPanel setProperties invoked ")     ;
        //Thread.dumpStack();
