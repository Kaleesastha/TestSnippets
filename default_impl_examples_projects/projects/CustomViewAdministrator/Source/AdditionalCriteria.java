//$Id: AdditionalCriteria.java,v 1.1.1.1 2006/12/08 11:57:39 gramkumar Exp $
...
public class AdditionalCriteria extends JDialog implements ActionListener
{
	...
	Vector filledProps=new Vector();
	boolean confirm=false;
  public AdditionalCriteria()
  {
    //<Begin_AdditionalCriteria>
    pack();
    this.setTitle("AdditionalCriteria");
...
public AdditionalCriteria(String s,Properties prop,Vector vec)
{
	pack();
	title=s;
	this.setTitle(title);
	...
	else
	{
		...
		boolean isEntered=false;		
	          for(Enumeration e=prop.propertyNames();e.hasMoreElements();)
	          {
		       ...
		       if(filledProps!=null && filledProps.contains(key))
		       {
			continue;
		       }
	                 addRow(count);
	                 Vector v=(Vector)finalVector.elementAt(count);
 	                 ((JCheckBox)v.elementAt(0)).setSelected(true);
	                 	
	                  ((JTextField)v.elementAt(1)).setText(key);
	                  ((JTextField)v.elementAt(2)).setText(prop.getProperty(key));
	                  count++;	
		        isEntered=true;		
		        selProps.put(key,prop.getProperty(key));				
...
public boolean getConfirm()
{
    ...
    public void init()
  {
        ...
        this.setSize(getPreferredSize().width+468,getPreferredSize().height+236); 
          setTitle("Criteria dialog");
  ...
  //<Begin_setUpProperties> 
          ...
          try
          {
            JPanel1.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.LineBorder(new Color(-16777216),1),"Specify additional criteria",1,0,new Font("Dialog",0,12),new Color(-16764109)));
          }
          catch(Exception ex)
          {
          ...
          try
          {
            ...
            more.setText("More");
            more.setBorder(new javax.swing.border.BevelBorder(0));
            more.setMaximumSize(new Dimension(40,27));
            more.setMinimumSize(new Dimension(40,27));
            more.setPreferredSize(new Dimension(40,27));
          }
          catch(Exception ex)
          {
          ...
          try
          {
            ...
            fewer.setBorder(new javax.swing.border.BevelBorder(0));
            fewer.setMaximumSize(new Dimension(40,27));
            fewer.setMinimumSize(new Dimension(40,27));
            fewer.setPreferredSize(new Dimension(40,27));
            fewer.setText("Fewer");
          }
          catch(Exception ex)
          {
          ...
          try
          {
            ...
            remove.setBorder(new javax.swing.border.BevelBorder(0));
            remove.setMaximumSize(new Dimension(40,21));
            remove.setMinimumSize(new Dimension(40,21));
            remove.setPreferredSize(new Dimension(40,21));
          ...
          try
          {
            ...
            ok.setMaximumSize(new Dimension(40,27));
            ok.setMinimumSize(new Dimension(40,27));
            ok.setPreferredSize(new Dimension(40,27));
          }
          catch(Exception ex)
          {
          ...
          try
          {
            ...
            cancel.setMaximumSize(new Dimension(40,27));
            cancel.setMinimumSize(new Dimension(40,27));
            cancel.setPreferredSize(new Dimension(40,27));
          }
          catch(Exception ex)
          {
             showStatus("Exception while setting properties for bean "+cancel,ex); 
          }
		cancel.setPreferredSize(new Dimension(cancel.getPreferredSize().width+41,cancel.getPreferredSize().height+0));
		ok.setPreferredSize(new Dimension(ok.getPreferredSize().width+41,ok.getPreferredSize().height+0));
		remove.setPreferredSize(new Dimension(remove.getPreferredSize().width+41,remove.getPreferredSize().height+4));
		fewer.setPreferredSize(new Dimension(fewer.getPreferredSize().width+41,fewer.getPreferredSize().height+0));
		more.setPreferredSize(new Dimension(more.getPreferredSize().width+41,more.getPreferredSize().height+0));
		JPanel1.setPreferredSize(new Dimension(JPanel1.getPreferredSize().width+10,JPanel1.getPreferredSize().height+10));

  
          //<End_setUpProperties>
		String s="Specify "+title;
		JPanel1.setBorder(new javax.swing.border.TitledBorder(new javax.swing.border.LineBorder(new Color(-16777216),1),s,1,0,new Font("Dialog",0,12),new Color(-16764109)));
  } 
  public void start()
  {
  //<Begin_start> 
...
//<End_setUpGUI_Container>
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource().equals(remove))
		{
	    	   ...
	    	   for(int i=finalVector.size()-1;i>=0;i--)
		   {
		       ...
		       if(((JCheckBox)v.elementAt(0)).isSelected())
		        {
			removeRow(i);
			count--;			
		        }
  ...
  public Properties getProperties()
  {
	...
	for(int i=0;i<finalVector.size();i++)
	{
		...
		//if(((JCheckBox)v.elementAt(0)).isSelected())
		//{
		if(!((JTextField)v.elementAt(1)).getText().trim().equals("")||!((JTextField)v.elementAt(2)).getText().trim().equals(""))
		{
			prop.put(((JTextField)v.elementAt(1)).getText(),((JTextField)v.elementAt(2)).getText());
		}
		//}
	}
	return prop;
