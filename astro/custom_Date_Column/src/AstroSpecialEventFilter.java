...
public class AstroSpecialEventFilter extends SpecialEventFilter {
	...
	public AstroSpecialEventFilter (EventBrowser eb){
		super(eb);
	}
	...
	public Hashtable validateCustomColumns (PropForm form,Properties columnProps){
		...
		//String deviceTimeCriteria = dateValidation(ts,ts2,NmsClientUtil.GetString("deviceTimeStamp"));
		String deviceTimeCriteria = this.dateValidation(ts,ts2);
