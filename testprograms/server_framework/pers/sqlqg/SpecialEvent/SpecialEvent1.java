 ...
 */ 
public class SpecialEvent1 extends Event
{

	private String specialEventName="defaultName";
    private int specialEventSeverity =2;
    private String specialEventId = "defaultId";
    public int getId()
	{
		return super.getId();
		//return id;
    ...
    public void setSpecialEventId(String word)
    {
        this.specialEventId = word;
    }
    ...
    public void setProperties(Properties p)
    {
        ...
        if((val = (String)p.remove("specialEventId"))!= null)
        {
            this.specialEventId = val;
        }
    ...
    public Properties getProperties()
    {
        ...
        {
            p.put("specialEventId",specialEventId);
        }
