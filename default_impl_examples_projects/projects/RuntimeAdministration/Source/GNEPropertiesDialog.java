/* $Id: GNEPropertiesDialog.java,v 1.1 2006/08/29 13:57:02 build Exp $ */
...
public class GNEPropertiesDialog extends JDialog 
{
  ...
  public void init()
  {
	...
	resourceBundle = com.adventnet.apiutils.Utility.getBundle(localePropertiesFileName,getParameter("RESOURCE_LOCALE"),applet);
        ...
        this.setSize(getPreferredSize().width+508,getPreferredSize().height+470); 
          setTitle(resourceBundle.getString("GNEPropertiesDialog"));
...
//<UserCode_End_Bean_JTextField1>
          ...
          try
          {
            ...
            JLabel1.setText(resourceBundle.getString("GNE IP"));
          }
          catch(Exception ex)
          {
...
//<UserCode_End_Bean_JLabel1>
          ...
          try
          {
            ...
            JLabel3.setText(resourceBundle.getString("GNE Properties"));
          }
          catch(Exception ex)
          {
...
//<UserCode_End_Bean_JButton2>
		...
		JLabel3.setPreferredSize(new Dimension(JLabel3.getPreferredSize().width+48,JLabel3.getPreferredSize().height+1));
...
//<End_setUpGUI_Container>
  ...
  public GNEPropertiesDialog()
  {
    //<Begin_GNEPropertiesDialog>
    pack();
  
    //<End_GNEPropertiesDialog>
    setModal(true);
  }

  public GNEPropertiesDialog(java.applet.Applet applet)
  {
    //<Begin_GNEPropertiesDialog_java.applet.Applet>
    this.applet = applet;
    pack();
    this.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
  
    //<End_GNEPropertiesDialog_java.applet.Applet>
  } 
  ...
  public void setConstraints(int x,int y,int width,int height,double wtX,double wtY,int anchor,int fill,Insets inset,int padX,int padY )
  {
    ...
    public void showGNEDlg(Hashtable props)
    {
        clear();
        currProps = props;
