/* $Id: ejbget.java,v 1.1.1.1 2006/11/16 15:39:58 gramkumar Exp $ */
/*
 * @(#)ejbget.java
 ...
 *
 * java ejbget [options] host oid ...
 *
 *<img SRC="images/v3only.jpg" ALT="v3 only"> v3 request:
 * java ejbget [-SnmpEJBServer hostName] [-v version(v1,v2,v3)] [-m MIB_files] [-c community] [-p port] [-t timeout] [-r retries] [-u user] [-a auth_protocol] [-w auth_password] [-s priv_password] [-i contextID] [-n contextName] host OID [OID] ...
 * e.g. 
 * java ejbget -v v3 -m ..\..\mibs\rfc1213-MIB -u user -a MD5 -w passwd localhost 1.2.0
 *
 *<img SRC="images/v2candv3only.jpg" ALT="v2c and v3 only"> v2c request:
 * java ejbget [-SnmpEJBServer hostName] [-v version(v1,v2)] [-m MIB_files] [-c community] [-p port] [-t timeout] [-r retries] host OID [OID] ...
 * e.g. 
 * java ejbget -v v2 -m ..\..\mibs\rfc1213-MIB localhost 1.2.0
 *
 * v1 request:
 * java ejbget [-SnmpEJBServer hostName] [-m MIB_files] [-c community] [-p port] [-t timeout] [-r retries] host OID [OID] ...
 * e.g. 
 * java ejbget -m ..\..\mibs\rfc1213-MIB localhost 1.2.0
 *
* Options:
...
public class ejbget  {
	...
	public static void main(String args[])	{
        ...
        String usage = "ejbget [-SnmpEJBServer hostName] [-v version(v1,v2,v3)] [-m MIB_files] [-c community] [-p port] [-t timeout] [-r retries] [-u user] [-a auth_protocol] [-w auth_password] [-s priv_password] [-i contextID] [-n contextName] host OID [OID] ...";
	...
	try {
        ...
        resultSeq = target.snmpGetList( );// do a get request
