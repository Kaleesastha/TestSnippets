//$Id: VariableBindingList.java,v 1.3 2010/11/10 10:28:20 aravinds Exp $
...
public class VariableBindingList extends javax.swing.JDialog {
	...
	gridBagConstraints.weighty = 0.1;
        ...
        oid.setName(NmsClientUtil.GetString("javaui.filter.OIDValue"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        value.setName(NmsClientUtil.GetString("javaui.filter.SetValue"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    ...
    public String checkString(JTextField textField)
	{ 
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        String gvalue = checkString(value);
        if(gvalue == null)
        {
            return;
        }
