/* $Id: RMIClientDemo_Table.java,v 1.1.1.1 2006/11/16 15:39:58 gramkumar Exp $ */
 ...
 */
public class RMIClientDemo_Table extends JFrame implements ActionListener
{
	...
	else if(ae.getSource() == refreshBut)
	{
	    try 
	    {
		if(!rmiClient.isConnectedWithAdaptor().booleanValue())
		{
    ...
    /*
     * The connection with the Rmi Adaptor is established. The attributes and operations of the ProxyTable
 	...
 	try
	{
	    ...
	    rmiClient.connect(hostText.getText(),Integer.parseInt(portText.getText()),null);
     ...
     * read and are displayed in the UI.
     */
    Vector getAllValues()
    {
 	try
	{
		...
		{
		    td = (TabularData)rmiClient.invoke(objectName,opeInfo[i].getName(),new Object[]{},new String[]{});
		    break;
		}
	    }
	...
	try
	{
		...
		{
		    Object result = rmiClient.invoke(objectName,opeInfo[i].getName(),value,type);
		}
	    }
	...
	RMIClientDemo_Table frame = new RMIClientDemo_Table();
