//$Id: CryptoPropertyAccessor.java $
...
/**
 * For any property of ManagedObject or its subclasses of type String,
 * specify this accessor to enable encryption and decryption.
 */
public class CryptoPropertyAccessor implements PropertyAccessor {
	...
	public static final class BasicSetter implements Setter {
		...
		throws HibernateException {
			try {
			  // here you can use your own decryption method instead of the proprietary algorithm
			  // used below.
			  	String decryptVal = Coding.convertFromBase(val.toString());
				method.invoke( target, new Object[] { decryptVal } );
			}
