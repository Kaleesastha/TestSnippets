...
//$Id: AdventnetScreen.java,v 1.1 2006/08/29 13:57:02 build Exp $
...
public class AdventnetScreen extends JPanel 
{
  ...
  public AdventnetScreen()
  {
    //<Begin_AdventnetScreen>
    this.init();
  
    //<End_AdventnetScreen>
	uiUtils = RuntimeConfigFrame.getCommonBuilderUIImpl();
	
JButton1.setIcon(uiUtils.getImage("background.png","images/runtimeadmin"));
	JButton1.setHorizontalAlignment(SwingConstants.CENTER);
  }

  public AdventnetScreen(java.applet.Applet applet)
  {
    //<Begin_AdventnetScreen_java.applet.Applet>
    this.applet = applet;
    this.init();
  
    //<End_AdventnetScreen_java.applet.Applet>
  }
  ...
  //<Begin_init> 
	...
	resourceBundle = com.adventnet.apiutils.Utility.getBundle(localePropertiesFileName,getParameter("RESOURCE_LOCALE"),applet);
        ...
        setPreferredSize(new Dimension(getPreferredSize().width+650,getPreferredSize().height+440)); 
